...
class Kenza240ISEMachine extends \KBLIS\Instrumentation\AbstractInstrumentor
{
    /**
    ...
    public function getEquipmentInfo()
    {
        return array(
            ...
            'testTypes' => array("Liver Function Tests (Paeds)", "Minerals (Paeds)", "Glucose (Paeds)", "HbA1c (Paeds)", "Lipogram (Paeds)", "Renal Function Tests (Paeds)", "Electrolytes (Paeds)")
        );
    }
