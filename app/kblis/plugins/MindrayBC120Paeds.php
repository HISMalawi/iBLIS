...
class  MindrayBC120Paeds extends \KBLIS\Instrumentation\AbstractInstrumentor
{
    /**
    ...
    public function getEquipmentInfo()
    {
        return array(
            'code' => ' MBC120-paeds',
            'name' => 'Mindray BC 120 Paeds',
            'description' => 'Automatic Analyzer for Enzymes',
            'testTypes' => array("Renal Function Tests (Paeds)", "Electrolytes (Paeds)", "Liver Function Tests (Paeds)", "Minerals (Paeds)", "Glucose (Paeds)")
        );
    }
