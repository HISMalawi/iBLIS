    ...
    public function store($measures)
    {
        ...
        foreach ($measures as $data) {
		 ...
		 for ($i=0; $i < count($val['val']); $i++) { 
                    ...
                    $measurerange->interpretation = $val['interpretation'][$i];
                   // $measurerange->hl7_identifier = $val['hl7_identifier'];
                   // $measurerange->hl7_text = $val['hl7_text'];
                   // $measurerange->hl7_coding_system = $val['hl7_coding_system'];
                    $measurerange->save();
                }
            }
        }
