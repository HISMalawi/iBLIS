    ...
    <div>
        ...
        @endif
            ...
            {{ Form::open(array('route' => 'test.createOrderRetrospective',  'method' => 'POST', 'id' => 'wizard7', 'class' => "wizard needs-validation", 'data-style'=>"1",'novalidate')) }}
                ...
                <!--Step 3-->
                <h3>Mother/CareGiver Information</h3>
                <div class="wizard-content">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            <div class="card">
                                <div class="panel panel-default panel-info">
                                    <div class="panel-heading">
                                        <strong>Section 4:</strong> Mother/CareGiver Details
                                    </div>
                                </div>
                                <div class="card-body">
                ...
                <div class="wizard-content">
                        ...
                        <div class="mt-1">
                            <div class="panel panel-info">
                                ...
                                <div>
                                    <div class="custom-padding" style="background-color: #f9fafb;">
                                        <strong>Section 4: Mother/Caregiver Details</strong>
                                    </div>
    
                                    <div class="row" style="padding-left: 20px;">
                                        <div class="col-md-4 custom-padding" >
                                            <div class="mt-1"><label for="id">Mother/Caregiver Surname : &nbsp; </label>
                                                <p id="confi-eid-caregiver-surname">--</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 custom-padding" >
                                          <div class="mt-1"><label for="id">Mother/Caregiver First Name : &nbsp; </label>
                                              <p id="confi-eid-caregiver-firstname">--</p>
                                          </div>
                                      </div>
                                        <div class="col-md-4 custom-padding" >
                                            <div class="mt-1"><label for="id">Unique Child ID : &nbsp; </label>
        ...
        wizard7.steps({
            ...
            onStepChanged: function(event, currentIndex, priorIndex) {
                ...
                if (currentIndex == 4 || currentIndex == 5) {
                    ...
                    var caregiver_surname = $('#eid-caregiver-surname').val();
                    var caregiver_firstname = $('#eid-caregiver-firstname').val();
                    var child_unique_id = $('#unique-child-id').val();
                    ...
                    $('#confi-eid-caregiver-surname').text(caregiver_surname);
                    $('#confi-unique-child-id').text(child_unique_id);
                    $('#confi-eid-caregiver-firstname').text(caregiver_firstname);
