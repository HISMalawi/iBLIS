 ...
 **/
	...
	function showSpinner(action, clickOnClose, shieldOn) {
		...
		if(window.location.href.match(/viewdetails|checkResult|microbiologyMohReport|serologyMohReport|bloodBankMohReport|biochemistryMohReport|haematologyMohReport|patientreport|verify/i) || window.location.href.match(/print|machine\_test\_id\=\d+$/)) {
			hideSpinner();
			if ($('.modal')){
				$('.modal').modal('hide');
			}
