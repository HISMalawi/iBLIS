...
!(function (a, b) {
  ...
  function D(a, b, c) {
    if (b.enablePagination) {
      ...
      x = a.find(".actions a[href$='#reject']").parent(),
      t = a.find(".actions a[href$='#cancel']").parent(),
      ...
      b.enableFinishButton && b.showFinishButtonAlways
        ...
        : (d._showAria(
          ...
          e
            ...
            b.enableRejectButton && b.showRejectButtonAlways
            ? (x._enableAria(c.stepCount > 0),
              e._enableAria(c.stepCount > 1 && c.stepCount > c.currentIndex + 1))
            : (x._showAria(
                b.enableRejectButton && c.stepCount === c.currentIndex + 1
              ),
              e
                ._showAria(0 === c.stepCount || c.stepCount > c.currentIndex + 1)
                ._enableAria(
                  c.stepCount > c.currentIndex + 1 || !b.enableRejectButton
                ));

                b.enableRejectButton && b.showRejectButtonAlways
                ? (t._enableAria(c.stepCount > 0),
                  e._enableAria(c.stepCount > 1 && c.stepCount > c.currentIndex + 1))
                : (t._showAria(
                    b.enableRejectButton && c.stepCount === c.currentIndex + 1
                  ),
  ...
  function L(a, b, c) {
    if (b.enablePagination) {
      ...
      b.forceMoveForward || (f += e.format("previous", b.labels.previous)),
        ...
        b.enableRejectButton && (f += e.format("reject", b.labels.reject)),
  ...
  var $ = (a.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 }),
    ...
    cb = (a.fn.steps.defaults = {
      ...
      enableRejectButton: !0,
      enableFinishButton: !0,
      preloadContent: !1,
      showFinishButtonAlways: !1,
      showCancelButtonAlways: !1,
      showRejectButtonAlways: !1,
      forceMoveForward: !1,
      saveState: !1,
      startIndex: 0,
